...
const Navbar = () => {
  ...
  return (
    <>
      {!isMobile ? (
        <header className="flex flex-row justify-between  px-5 fixed bg-black w-[100%] z-50">
        ...
        <header className="flex flex-row  py-5 px-5 fixed bg-black w-[100%] z-50 ">
          ...
          <div className="flex flex-row mb-3 mt-1 gap-2   ">
            <div className=" bg-green-500 cursor-pointer p-2 px-3 rounded-3xl text-black">
